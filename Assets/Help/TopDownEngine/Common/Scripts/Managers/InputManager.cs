...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
		...
		public MMInput.IMButton InventoryLeftButton { get; protected set; }

		public MMInput.IMButton InventoryRightButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
			...
			ButtonList.Add(InventoryLeftButton = new MMInput.IMButton(PlayerID, "Inventory_Left", InventoryLeftButtonDown, InventoryLeftButtonPressed, InventoryLeftButtonUp));
            ButtonList.Add(InventoryRightButton = new MMInput.IMButton(PlayerID, "Inventory_Right", InventoryRightButtonDown, InventoryRightButtonPressed, InventoryRightButtonUp));
        }
		...
		public virtual void InventoryLeftButtonDown() { InventoryLeftButton.State.ChangeState (MMInput.ButtonStates.ButtonDown); }
        public virtual void InventoryLeftButtonPressed() { InventoryLeftButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void InventoryLeftButtonUp() { InventoryLeftButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }

        public virtual void InventoryRightButtonDown() { InventoryRightButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
        public virtual void InventoryRightButtonPressed() { InventoryRightButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void InventoryRightButtonUp() { InventoryRightButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
