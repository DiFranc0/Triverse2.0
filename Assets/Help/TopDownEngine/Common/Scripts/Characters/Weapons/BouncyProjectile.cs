...
{	
	...
	public class BouncyProjectile : Projectile 
	{
		...
		protected MMPreventPassingThrough3D _prevent;
		


		public LayerMask _originalLayerMask;
		public LayerMask _targetLayerMaskChange;
		public LayerMask _preventPassLayerChange;
		public LayerMask _preventPassLayerOriginal;
		...
		protected override void Initialization()
		{
			...
			_damage.TargetLayerMask = _originalLayerMask;

			_prevent = GetComponent<MMPreventPassingThrough3D>();
			_prevent.ObstaclesLayerMask = _preventPassLayerOriginal;
		...
		{
            //_damage = GetComponent<DamageOnTouch>();
            _damage.TargetLayerMask = _targetLayerMaskChange;
			_prevent.ObstaclesLayerMask = _preventPassLayerChange;
		}

		public void OriginalTarget()
		{
            //_damage = GetComponent<DamageOnTouch>();
			_damage.TargetLayerMask = _originalLayerMask;
			_prevent.ObstaclesLayerMask = _preventPassLayerOriginal;
